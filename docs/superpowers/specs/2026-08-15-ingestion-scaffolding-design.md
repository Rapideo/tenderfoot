...
**2. The merge step is out of scope here and does not exist yet.** This design lands sightings. Producing canonical solicitations by merging them is real work with no home in the plan. **It is the natural first task of whatever consumes this**, and should not be discovered late.
