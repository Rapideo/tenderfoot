...
| 📎 **`THOUGHTS.md` is untracked** — four ideas from 2026-08-11, unprotected by git on a machine that zeroed a branch ref on 2026-08-13. **At least two are not scratch:** *levels of research and qualifying against that research* sits directly beside the qualification work parked as **undesigned**, and *what analysis 20+ years of historical data enables* is a real question about the 2,160-contract corpus. **Matt's file — Claude has not touched it.** Decide: commit as-is, or promote the live ones into backlog | Nothing yet — but it is one crash from being lost |
